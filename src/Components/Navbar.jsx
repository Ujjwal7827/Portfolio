...
const Navbar = () => {
  ...
  return (
      ...
      data-aos="fade-down">
          ...
          <ul id='list' className={`${menu ? "block" : "hidden"} absolute  left-5  bg-black bg-opacity-30 md:bg-transparent 
           md:relative md:flex md:gap-10 md:justify-end md:p-0 md:mt-0 md:flex-row md:items-center md:text-center md:border-none md:mx-0`}>
            <a href="#Home">
